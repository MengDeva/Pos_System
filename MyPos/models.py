...
class Category(models.Model):
    ...
    createBy=models.ForeignKey(User,on_delete=models.CASCADE,related_name="Category")
...
class SaleDetail(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="SaleDetail")
    qty=models.IntegerField()
